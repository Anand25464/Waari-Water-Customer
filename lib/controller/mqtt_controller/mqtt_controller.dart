...
class MqttController extends ChangeNotifier {
  ...
  var currentTopic = "".obs;
  String get getCurrentTopic => currentTopic.value;
  set setCurrentTopic(String val){
    currentTopic.value = val;
    currentTopic.refresh();
  }
  ...
  Future<void> subscribe(String topic, void Function(String) onMessage) async {
    if (client.connectionStatus!.state == MqttConnectionState.connected) {
      ...
      try {
        ...
        Get.snackbar("Error", "Unable to subscribe to the topic");
        // Handle the error or retry the operation as needed
        return;
      }
      ...
      print('Error: MQTT connection not yet established.');
      Get.snackbar("Error", "Unable to subscribe to the topic - MQTT connection not established");
      // Handle the error or retry the operation as needed
    }
  }
